(function () {
	...
	/*! prism-nsis | MIT License | github.com/idleberg/prismjs-nsis */
	 ...
	 Prism.languages.nsis = {
		...
		'property': /\b(?:ARCHIVE|FILE_ATTRIBUTE_(?:ARCHIVE|NORMAL|OFFLINE|READONLY|SYSTEM|TEMPORARY)|HK(?:C(?:R(?:(?:32|64))?|U(?:(?:32|64))?)|DD|EY_(?:C(?:LASSES_ROOT|URRENT_(?:CONFIG|USER))|DYN_DATA|LOCAL_MACHINE|PERFORMANCE_DATA|USERS)|LM(?:(?:32|64))?|PD|U)|ID(?:ABORT|CANCEL|IGNORE|NO|OK|RETRY|YES)|MB_(?:ABORTRETRYIGNORE|DEFBUTTON[1234]|ICON(?:EXCLAMATION|INFORMATION|QUESTION|STOP)|OK(?:CANCEL)?|R(?:ETRYCANCEL|IGHT|TLREADING)|SETFOREGROUND|TOPMOST|USERICON|YESNO)|NORMAL|OFFLINE|READONLY|S(?:H(?:CTX|ELL_CONTEXT)|YSTEM)|TEMPORARY|a(?:dmin|ll|uto)|both|colored|f(?:alse|orce)|hi(?:de|ghest)|l(?:astused|eave|istonly)|no(?:ne|rmal|tset)|o(?:ff|pen|n)|print|s(?:how|ilent(?:log)?|mooth)|t(?:extonly|rue)|user)\b/,
		'constant': /\${[\w.:^-]+}|\$\([\w.:^-]+\)/i,
		'variable': /\$\w+/i,
		...
		'punctuation': /[{}[\];(),.:]/,
		'important': {
			pattern: /(^\s*)(?:!(?:a(?:dd(?:includedir|plugindir)|ppendfile)|cd|de(?:fine|lfile)|e(?:cho|lse|ndif|rror|xecute)|finalize|get(?:dllversion|tlbversion)|i(?:f(?:(?:def|macro(?:def|ndef)|ndef))?|n(?:clude|sertmacro))|ma(?:cro(?:end)?|kensis)|p(?:ackhdr|ragma)|s(?:earch(?:parse|replace)|ystem)|tempfile|undef|verbose|warning)|e(?:lse|ndif)|if(?:(?:def|macro(?:def|ndef)|ndef))?)\b/mi,
			lookbehind: true
		}
	};
